...
class ProjectGroup(models.Model):
    ...
    leader = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name="leading_groups")
...
class Faculty(models.Model):
    ...
    group = models.ForeignKey(ProjectGroup, on_delete=models.SET_NULL, null=True, blank=True, related_name="faculties") #
...
class Student(models.Model):
    ...
    group = models.ForeignKey(ProjectGroup, on_delete=models.SET_NULL, null=True, blank=True, related_name="students") #
    def __str__(self):
